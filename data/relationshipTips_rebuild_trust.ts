...
export const REBUILD_TRUST_TIPS: SimplifiedTip[] = [
  {
...
• Acknowledge to your partner that you kept it`,
    ...
    "contraindications": [],
    "mechanisms": ["consistency_building", "small_wins", "reliability_demonstration"],
    "effort": "minimal",
    "time": "varies",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["promises", "follow_through"],
    "features": ["action_based", "trust_builder"],
    "difficulty": 1,
...
• Do this without being asked`,
    ...
    "contraindications": [],
    "mechanisms": ["voluntary_disclosure", "transparency", "predictability"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["daily"],
    "where": ["any"],
    "involves": ["communication", "sharing"],
    "features": ["proactive", "transparency_tool"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Share what you'll do differently`,
    ...
    "contraindications": [],
    "mechanisms": ["voluntary_accountability", "integrity_demonstration", "ownership"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["confession", "ownership"],
    "features": ["integrity_practice", "proactive"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Thank them for sharing`,
    ...
    "contraindications": [],
    "mechanisms": ["boundary_respect", "permission_seeking", "autonomy_support"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["home"],
    "involves": ["permission", "respect"],
    "features": ["boundary_tool", "respect_practice"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Don't monitor their response`,
    ...
    "contraindications": [],
    "mechanisms": ["voluntary_vulnerability", "transparency", "trust_demonstration"],
    "effort": "low",
    "time": "5-15min",
    "cost": "$",
    "when": ["planned"],
    "where": ["private"],
    "involves": ["sharing", "vulnerability"],
    "features": ["vulnerability_practice", "trust_gesture"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Share the completion without seeking praise`,
    ...
    "contraindications": [],
    "mechanisms": ["completion", "accountability", "pattern_breaking"],
    "effort": "moderate",
    "time": "30-60min",
    "cost": "$",
    "when": ["planned"],
    "where": ["any"],
    "involves": ["action", "completion"],
    "features": ["action_focused", "pattern_breaker"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Include details willingly`,
    ...
    "contraindications": [],
    "mechanisms": ["schedule_sharing", "transparency", "predictability"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["once", "daily_updates"],
    "where": ["any"],
    "involves": ["technology", "calendar", "planning"],
    "features": ["tech_tool", "ongoing_practice"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Ask what they still need for healing`,
    ...
    "contraindications": [],
    "mechanisms": ["proactive_care", "accountability", "healing_support"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned"],
    "where": ["private", "safe_space"],
    "involves": ["conversation", "vulnerability"],
    "features": ["healing_focused", "proactive"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Apologize for any lateness without excuses`,
    ...
    "contraindications": [],
    "mechanisms": ["time_respect", "consistency", "reliability"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["daily"],
    "where": ["any"],
    "involves": ["time_management", "planning"],
    "features": ["daily_practice", "respect_demonstration"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Ask for reassurance if needed`,
    ...
    "contraindications": [],
    "mechanisms": ["vulnerable_sharing", "fear_disclosure", "intimacy_building"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned", "calm_moment"],
    "where": ["private", "safe_space"],
    "involves": ["vulnerability", "sharing", "courage"],
    "features": ["deep_sharing", "courage_practice"],
    "difficulty": 4,
    "source": "coach_curated",
    "sustainability": "monthly"
  }
