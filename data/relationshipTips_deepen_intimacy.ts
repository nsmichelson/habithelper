...
export const DEEPEN_INTIMACY_TIPS: SimplifiedTip[] = [
  {
...
• Thank them for holding space for you",
    ...
    "contraindications": [],
    "mechanisms": ["unprecedented_sharing", "vulnerability", "trust_demonstration"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned", "private_time"],
    "where": ["home", "private"],
    "involves": ["deep_sharing", "vulnerability"],
    "features": ["deep_intimacy", "trust_building"],
    "difficulty": 4,
...
• Take mental notes for future actions",
    ...
    "contraindications": [],
    "mechanisms": ["direct_inquiry", "love_mapping", "effectiveness_improvement"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening", "calm_moment"],
    "where": ["home", "private"],
    "involves": ["deep_conversation", "listening"],
    "features": ["learning_tool", "love_optimization"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Notice what arises without speaking",
    ...
    "contraindications": [],
    "mechanisms": ["eye_contact", "neural_synchronization", "presence"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["evening", "quiet_time"],
    "where": ["home", "private"],
    "involves": ["eye_contact", "silence", "presence"],
    "features": ["non_verbal", "powerful_simple"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Allow them to comfort you",
    ...
    "contraindications": [],
    "mechanisms": ["fear_sharing", "vulnerability", "value_demonstration"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned", "safe_moment"],
    "where": ["private", "home"],
    "involves": ["vulnerability", "fear_sharing"],
    "features": ["deep_sharing", "bonding"],
    "difficulty": 4,
    "source": "coach_curated",
    "sustainability": "rarely"
  },
  {
...
• Create a shared picture of your future",
    ...
    "contraindications": [],
    "mechanisms": ["vision_sharing", "future_alignment", "co_creation"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["weekend", "planned"],
    "where": ["home", "quiet_space"],
    "involves": ["visioning", "planning", "dreaming"],
    "features": ["future_focused", "alignment_tool"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Ask: \"How can I help you feel good in your body?\"",
    ...
    "contraindications": [],
    "mechanisms": ["vulnerable_inquiry", "body_awareness", "support_offering"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["private_moment", "planned"],
    "where": ["private", "safe_space"],
    "involves": ["sensitive_conversation", "support"],
    "features": ["sensitive_topic", "support_focused"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Thank them for receiving it without judgment",
    ...
    "contraindications": [],
    "mechanisms": ["desire_disclosure", "trust_building", "expansion"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["private_time", "planned"],
    "where": ["private", "bedroom"],
    "involves": ["vulnerability", "desire_sharing"],
    "features": ["intimate_sharing", "trust_exercise"],
    "difficulty": 4,
    "source": "coach_curated",
    "sustainability": "rarely"
  },
...
• Stay present with the touch",
    ...
    "contraindications": [],
    "mechanisms": ["intentional_touch", "oxytocin_release", "care_exchange"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening", "before_bed"],
    "where": ["bedroom", "home"],
    "involves": ["massage", "touch", "care"],
    "features": ["physical_connection", "stress_relief"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Be genuinely appreciative",
    ...
    "contraindications": [],
    "mechanisms": ["attraction_recall", "desire_expression", "validation"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["evening", "romantic_moment"],
    "where": ["home", "private"],
    "involves": ["sharing", "memories", "appreciation"],
    "features": ["romance_builder", "validation"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Notice how you feel in the morning",
    ...
    "contraindications": [],
    "mechanisms": ["skin_contact", "overnight_bonding", "physical_closeness"],
    "effort": "minimal",
    "time": "overnight",
    "cost": "$",
    "when": ["bedtime", "nightly"],
    "where": ["bedroom"],
    "involves": ["sleep", "physical_contact"],
    "features": ["overnight_practice", "bonding"],
    "difficulty": 2,
    "source": "coach_curated",
