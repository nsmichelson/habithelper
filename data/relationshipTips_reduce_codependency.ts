...
export const REDUCE_CODEPENDENCY_TIPS: SimplifiedTip[] = [
  {
...
• Notice it's okay to decide alone`,
    ...
    "contraindications": [],
    "mechanisms": ["autonomy_practice", "self_trust_building", "independence"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["decision_making", "independence"],
    "features": ["autonomy_builder", "self_trust_tool"],
    "difficulty": 2,
...
• Then share if still needed`,
    ...
    "contraindications": [],
    "mechanisms": ["self_processing", "emotional_regulation", "independence"],
    "effort": "minimal",
    "time": "10-15min",
    "cost": "$",
    "when": ["when_emotional"],
    "where": ["private_space"],
    "involves": ["emotional_processing", "solitude"],
    "features": ["emotional_independence", "self_regulation"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Share highlights when reunited`,
    ...
    "contraindications": [],
    "mechanisms": ["separation_practice", "identity_reinforcement", "independence"],
    "effort": "low",
    "time": "full_day",
    "cost": "$$",
    "when": ["weekend"],
    "where": ["separate_locations"],
    "involves": ["separate_activities", "independence"],
    "features": ["independence_day", "identity_builder"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Respect their individual expression`,
    ...
    "contraindications": [],
    "mechanisms": ["boundary_respect", "individual_expression", "patience"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["during_conversation"],
    "where": ["any"],
    "involves": ["conversation", "restraint"],
    "features": ["boundary_practice", "respect_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Say: \"We can disagree on this\"`,
    ...
    "contraindications": [],
    "mechanisms": ["difference_acceptance", "individuality_maintenance", "tolerance"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["disagreement", "acceptance"],
    "features": ["difference_tolerance", "individuality_preserver"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Share experiences when reunited`,
    ...
    "contraindications": [],
    "mechanisms": ["trust_building", "independence_practice", "anxiety_tolerance"],
    "effort": "minimal",
    "time": "varies",
    "cost": "$",
    "when": ["when_apart"],
    "where": ["any"],
    "involves": ["restraint", "trust"],
    "features": ["trust_builder", "independence_tool"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Maintain the friendship independently`,
    ...
    "contraindications": [],
    "mechanisms": ["social_independence", "individual_support", "identity_maintenance"],
    "effort": "moderate",
    "time": "2-3hrs",
    "cost": "$$",
    "when": ["weekly"],
    "where": ["various"],
    "involves": ["friendships", "socializing"],
    "features": ["social_independence", "support_builder"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Let them feel without rescuing`,
    ...
    "contraindications": [],
    "mechanisms": ["boundary_respect", "emotional_tolerance", "support_without_fixing"],
    "effort": "moderate",
    "time": "varies",
    "cost": "$",
    "when": ["when_upset"],
    "where": ["any"],
    "involves": ["emotional_support", "restraint"],
    "features": ["boundary_tool", "support_skill"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Protect this time regularly`,
    ...
    "contraindications": [],
    "mechanisms": ["individual_self_care", "personal_responsibility", "routine_independence"],
    "effort": "low",
    "time": "30-60min",
    "cost": "$",
    "when": ["daily"],
    "where": ["various"],
    "involves": ["self_care", "individual_practice"],
    "features": ["self_care_tool", "independence_builder"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Don't minimize or make it 'ours'`,
    ...
    "contraindications": [],
    "mechanisms": ["identity_reinforcement", "individual_recognition", "self_worth"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["after_achievements"],
    "where": ["any"],
    "involves": ["celebration", "recognition"],
    "features": ["identity_preserver", "self_worth_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  }
