...
export const PRIORITIZE_US_TIPS: SimplifiedTip[] = [
  {
...
• Use that time for connection`,
    ...
    "contraindications": [],
    "mechanisms": ["active_prioritization", "boundary_setting", "time_creation"],
    "effort": "low",
    "time": "varies",
    "cost": "$",
    "when": ["weekly"],
    ...
    "features": ["boundary_practice", "priority_demonstration"],
    "difficulty": 2,
...
• Plan simple or elaborate dates`,
    ...
    "contraindications": [],
    "mechanisms": ["scheduling", "commitment", "ritual_creation"],
    "effort": "low",
    "time": "2-3hrs",
    "cost": "$$",
    "when": ["weekly"],
    "where": ["various"],
    "involves": ["dating", "planning", "commitment"],
    "features": ["weekly_ritual", "relationship_investment"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Retrieve only after cleanup`,
    ...
    "contraindications": [],
    "mechanisms": ["device_boundary", "environmental_design", "presence_enforcement"],
    "effort": "minimal",
    "time": "30-60min",
    "cost": "$",
    "when": ["mealtime"],
    "where": ["home"],
    "involves": ["boundaries", "meals", "device_management"],
    "features": ["simple_rule", "environmental_solution"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Just be together`,
    ...
    "contraindications": [],
    "mechanisms": ["time_creation", "morning_ritual", "prioritization"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["morning"],
    "where": ["home"],
    "involves": ["morning_routine", "connection"],
    "features": ["daily_ritual", "day_starter"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Celebrate progress together`,
    ...
    "contraindications": [],
    "mechanisms": ["collaboration", "shared_purpose", "team_building"],
    "effort": "moderate",
    "time": "1-2hrs",
    "cost": "$$",
    "when": ["weekend"],
    "where": ["home"],
    "involves": ["projects", "collaboration", "creativity"],
    "features": ["ongoing_activity", "team_building"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Check in weekly on progress`,
    ...
    "contraindications": [],
    "mechanisms": ["goal_alignment", "intentionality", "accountability"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["planning", "goal_setting"],
    "features": ["monthly_practice", "growth_focused"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Enter as partner, not worker`,
    ...
    "contraindications": [],
    "mechanisms": ["ritual_boundary", "mental_transition", "compartmentalization"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["after_work"],
    "where": ["home_entrance"],
    "involves": ["ritual", "breathing", "transition"],
    "features": ["daily_practice", "boundary_ritual"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Other person shows up openly`,
    ...
    "contraindications": [],
    "mechanisms": ["responsibility_sharing", "turn_taking", "surprise_element"],
    "effort": "low",
    "time": "varies",
    "cost": "$$",
    "when": ["weekly"],
    "where": ["various"],
    "involves": ["planning", "dates", "responsibility"],
    "features": ["fairness_tool", "variety_creator"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Display it prominently`,
    ...
    "contraindications": [],
    "mechanisms": ["visualization", "co_creation", "dream_sharing"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$",
    ...
    "features": ["creative_activity", "future_focused"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Guard this time fiercely`,
    ...
    "contraindications": [],
    "mechanisms": ["time_protection", "boundary_setting", "ritual_space"],
    "effort": "minimal",
    "time": "2-3hrs",
    "cost": "$",
    "when": ["sunday_morning"],
    "where": ["home", "various"],
    "involves": ["boundaries", "time_protection"],
    "features": ["weekly_sacred_time", "boundary_practice"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  }
