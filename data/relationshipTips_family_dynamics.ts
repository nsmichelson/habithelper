...
export const FAMILY_DYNAMICS_TIPS: SimplifiedTip[] = [
  {
...
• Debrief afterward privately",
    ...
    "contraindications": [],
    "mechanisms": ["united_front", "boundary_agreement", "mutual_support"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["before_visits"],
    "where": ["home"],
    "involves": ["planning", "boundaries", "family"],
    "features": ["family_tool", "unity_builder"],
    "difficulty": 2,
...
• Build it year after year",
    ...
    "contraindications": [],
    "mechanisms": ["tradition_creation", "identity_building", "independence"],
    "effort": "low",
    "time": "varies",
    "cost": "$$",
    "when": ["holidays"],
    "where": ["home"],
    "involves": ["traditions", "planning", "creativity"],
    "features": ["tradition_builder", "identity_creator"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Plan improvements for next time",
    ...
    "contraindications": [],
    "mechanisms": ["joint_processing", "emotional_support", "team_building"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["after_family_events"],
    "where": ["home", "private"],
    "involves": ["discussion", "processing", "support"],
    "features": ["processing_tool", "support_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Present united front regardless",
    ...
    "contraindications": [],
    "mechanisms": ["burden_sharing", "role_alternation", "mutual_support"],
    "effort": "low",
    "time": "varies",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["communication", "boundaries", "support"],
    "features": ["fairness_tool", "burden_sharer"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Focus on your relationship",
    ...
    "contraindications": [],
    "mechanisms": ["time_boundary", "containment", "refocusing"],
    "effort": "minimal",
    "time": "10-15min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["home"],
    "involves": ["venting", "timer", "boundaries"],
    "features": ["time_limiter", "focus_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Remind yourselves why you chose it",
    ...
    "contraindications": [],
    "mechanisms": ["priority_setting", "guilt_management", "loyalty_demonstration"],
    "effort": "moderate",
    "time": "varies",
    "cost": "$",
    "when": ["monthly"],
    "where": ["any"],
    "involves": ["decision_making", "boundaries"],
    "features": ["priority_tool", "independence_builder"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Choose what roles to keep or change",
    ...
    "contraindications": [],
    "mechanisms": ["pattern_recognition", "origin_exploration", "conscious_choice"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["sharing", "reflection", "discussion"],
    "features": ["insight_tool", "pattern_breaker"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Practice before family events",
    ...
    "contraindications": [],
    "mechanisms": ["secret_communication", "support_system", "escape_planning"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["before_events"],
    "where": ["home"],
    "involves": ["planning", "communication", "signals"],
    "features": ["escape_tool", "support_system"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Make it non-negotiable",
    ...
    "contraindications": [],
    "mechanisms": ["recovery_planning", "couple_time", "decompression"],
    "effort": "minimal",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["after_visits"],
    "where": ["home"],
    "involves": ["recovery", "couple_time"],
    "features": ["recovery_tool", "reconnection"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Reinforce why it matters",
    ...
    "contraindications": [],
    "mechanisms": ["positive_reinforcement", "celebration", "validation"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["after_boundaries"],
    "where": ["any"],
    "involves": ["celebration", "acknowledgment"],
    "features": ["reinforcement_tool", "guilt_reducer"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  }
