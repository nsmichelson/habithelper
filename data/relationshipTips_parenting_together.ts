...
export const PARENTING_TOGETHER_TIPS: SimplifiedTip[] = [
  {
...
• Debrief at bedtime",
    ...
    "contraindications": [],
    "mechanisms": ["daily_alignment", "united_front", "consistency"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["morning"],
    "where": ["home"],
    "involves": ["parenting", "planning", "alignment"],
    "features": ["daily_practice", "parenting_tool"],
    "difficulty": 1,
...
• Discuss later if needed",
    ...
    "contraindications": [],
    "mechanisms": ["support_system", "self_awareness", "teamwork"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["home"],
    "involves": ["parenting", "support", "signals"],
    "features": ["support_tool", "burnout_prevention"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Watch kids internalize the respect",
    ...
    "contraindications": [],
    "mechanisms": ["public_appreciation", "modeling", "reinforcement"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["home"],
    "involves": ["praise", "parenting", "modeling"],
    "features": ["family_builder", "respect_model"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Agree on approach for coming week",
    ...
    "contraindications": [],
    "mechanisms": ["regular_communication", "collaborative_problem_solving", "planning"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["weekly"],
    "where": ["home"],
    "involves": ["meeting", "parenting", "planning"],
    "features": ["weekly_ritual", "communication_tool"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Use free time for self-care or couple time",
    ...
    "contraindications": [],
    "mechanisms": ["turn_taking", "time_creation", "balance"],
    "effort": "minimal",
    "time": "30-60min",
    "cost": "$",
    "when": ["bedtime"],
    "where": ["home"],
    "involves": ["bedtime", "routines", "turns"],
    "features": ["fairness_tool", "time_creator"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Discuss concerns privately later",
    ...
    "contraindications": [],
    "mechanisms": ["united_front", "delayed_discussion", "support"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["support", "restraint", "unity"],
    "features": ["unity_tool", "boundary_practice"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Focus on effort, not perfection",
    ...
    "contraindications": [],
    "mechanisms": ["positive_reinforcement", "celebration", "modeling"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["dinner"],
    "where": ["home"],
    "involves": ["sharing", "celebration", "family"],
    "features": ["family_ritual", "positivity_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Other parent handles remaining kids",
    ...
    "contraindications": [],
    "mechanisms": ["individual_attention", "special_time", "rotation"],
    "effort": "low",
    "time": "30-60min",
    "cost": "$",
    "when": ["weekly"],
    "where": ["various"],
    "involves": ["one_on_one", "activities", "bonding"],
    "features": ["bonding_tool", "individual_focus"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Face chaos as a team",
    ...
    "contraindications": [],
    "mechanisms": ["team_reinforcement", "support", "solidarity"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["during_chaos"],
    "where": ["any"],
    "involves": ["support", "teamwork", "encouragement"],
    "features": ["quick_support", "team_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "as_needed"
  },
...
• Focus on being partners",
    ...
    "contraindications": [],
    "mechanisms": ["role_separation", "couple_focus", "romance_maintenance"],
    "effort": "moderate",
    "time": "3-4hrs",
    "cost": "$$$",
    "when": ["monthly"],
    "where": ["out"],
    "involves": ["date_night", "childcare", "romance"],
    "features": ["romance_protector", "identity_preserver"],
    "difficulty": 3,
    "source": "coach_curated",
