...
export const BUILD_FRIENDSHIP_TIPS: SimplifiedTip[] = [
  {
...
• Laugh together about life's absurdities`,
    ...
    "contraindications": [],
    "mechanisms": ["humor_sharing", "daily_ritual", "friendship_building"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["humor", "sharing", "laughter"],
    "features": ["friendship_builder", "daily_fun"],
    "difficulty": 1,
...
• Laugh at yourselves`,
    ...
    "contraindications": [],
    "mechanisms": ["shared_play", "public_fun", "conspiracy"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["public"],
    "involves": ["silliness", "play", "public"],
    "features": ["friendship_fun", "bonding_activity"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Enjoy your private humor`,
    ...
    "contraindications": [],
    "mechanisms": ["shared_humor", "private_reference", "bond_building"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["humor", "observation", "creativity"],
    "features": ["bond_creator", "friendship_tool"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Appreciate their passion`,
    ...
    "contraindications": [],
    "mechanisms": ["acceptance", "curiosity", "support"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["listening", "curiosity", "support"],
    "features": ["acceptance_practice", "friendship_support"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Trust them with your thoughts`,
    ...
    "contraindications": [],
    "mechanisms": ["intimate_sharing", "trust_building", "friendship_bonding"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["any"],
    "where": ["private"],
    "involves": ["gossip", "sharing", "trust"],
    "features": ["friendship_intimacy", "trust_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Celebrate victories as a team`,
    ...
    "contraindications": [],
    "mechanisms": ["collaboration", "teamwork", "shared_challenge"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["weekend"],
    "where": ["home"],
    "involves": ["challenges", "teamwork", "games"],
    "features": ["team_builder", "friendship_activity"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Chat when you want`,
    ...
    "contraindications": [],
    "mechanisms": ["casual_time", "companionship", "comfort_building"],
    "effort": "minimal",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["weekend"],
    "where": ["home"],
    "involves": ["hanging_out", "casual_time"],
    "features": ["casual_connection", "friendship_time"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Let them nickname you too`,
    ...
    "contraindications": [],
    "mechanisms": ["playful_naming", "humor", "private_language"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["nicknames", "humor", "play"],
    "features": ["playful_tool", "connection_builder"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Be their biggest fan`,
    ...
    "contraindications": [],
    "mechanisms": ["enthusiastic_support", "celebration", "cheerleading"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["celebration", "support", "enthusiasm"],
    "features": ["support_tool", "friendship_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Bond over being human`,
    ...
    "contraindications": [],
    "mechanisms": ["vulnerable_humor", "shared_humanity", "trust_building"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["sharing", "vulnerability", "humor"],
    "features": ["vulnerability_tool", "humor_builder"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  }
