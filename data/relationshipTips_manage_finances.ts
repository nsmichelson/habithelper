...
export const MANAGE_FINANCES_TIPS: SimplifiedTip[] = [
  {
...
• Thank each other for vulnerability",
    ...
    "contraindications": [],
    "mechanisms": ["fear_sharing", "vulnerability", "emotional_safety"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned"],
    "where": ["private"],
    "involves": ["money_talk", "vulnerability"],
    "features": ["financial_intimacy", "deep_sharing"],
    "difficulty": 3,
...
• No blame, just information sharing",
    ...
    "contraindications": [],
    "mechanisms": ["regular_review", "transparency", "brief_structure"],
    "effort": "minimal",
    "time": "10-15min",
    "cost": "$",
    "when": ["weekly"],
    "where": ["home"],
    "involves": ["money_review", "communication"],
    "features": ["weekly_ritual", "time_bounded"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Respect the boundary completely",
    ...
    "contraindications": [],
    "mechanisms": ["autonomy_preservation", "boundary_setting", "freedom"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["budgeting", "planning"],
    "features": ["autonomy_tool", "conflict_preventer"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Write it down to make it real",
    ...
    "contraindications": [],
    "mechanisms": ["dream_sharing", "visualization", "goal_alignment"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["dreaming", "planning", "visualization"],
    "features": ["dream_builder", "motivation_tool"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Make money wins feel good",
    ...
    "contraindications": [],
    "mechanisms": ["positive_association", "reinforcement", "celebration"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    ...
    "features": ["positivity_builder", "team_celebration"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Both stay informed throughout",
    ...
    "contraindications": [],
    "mechanisms": ["responsibility_sharing", "role_rotation", "skill_building"],
    "effort": "moderate",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["bill_paying", "budgeting", "management"],
    "features": ["fairness_tool", "skill_builder"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Notice patterns affecting you now",
    ...
    "contraindications": [],
    "mechanisms": ["origin_exploration", "pattern_recognition", "empathy_building"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["sharing", "memories", "reflection"],
    "features": ["deep_understanding", "pattern_revealer"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Celebrate completing the challenge",
    ...
    "contraindications": [],
    "mechanisms": ["shared_challenge", "constraint", "awareness_building"],
    "effort": "moderate",
    "time": "1 week",
    "cost": "$",
    "when": ["any_week"],
    "where": ["everywhere"],
    "involves": ["challenge", "restraint", "teamwork"],
    "features": ["money_saver", "team_challenge"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Value effort, not just amounts",
    ...
    "contraindications": [],
    "mechanisms": ["recognition", "appreciation", "value_acknowledgment"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["gratitude", "recognition"],
    "features": ["appreciation_tool", "resentment_preventer"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• End with something fun or romantic",
    ...
    "contraindications": [],
    "mechanisms": ["pleasure_pairing", "regular_rhythm", "positive_framing"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["monthly"],
    "where": ["home", "cafe"],
    "involves": ["planning", "review", "treats"],
    "features": ["monthly_ritual", "anxiety_reducer"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  }
