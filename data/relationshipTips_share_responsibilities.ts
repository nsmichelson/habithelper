...
export const SHARE_RESPONSIBILITIES_TIPS: SimplifiedTip[] = [
  {
...
• Appreciate what you each contribute",
    ...
    "contraindications": [],
    "mechanisms": ["visibility_creation", "acknowledgment", "awareness"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["planned"],
    "where": ["home"],
    "involves": ["listing", "sharing", "discussion"],
    "features": ["fairness_tool", "visibility_creator"],
    "difficulty": 2,
...
• Share appreciation for what you learned",
    ...
    "contraindications": [],
    "mechanisms": ["role_reversal", "empathy_building", "appreciation"],
    "effort": "low",
    "time": "varies",
    "cost": "$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["chores", "trading", "learning"],
    "features": ["empathy_builder", "role_flexibility"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Celebrate completion together",
    ...
    "contraindications": [],
    "mechanisms": ["shared_burden", "teamwork", "mutual_support"],
    "effort": "low",
    "time": "varies",
    "cost": "$",
    "when": ["weekly"],
    "where": ["home"],
    "involves": ["chores", "teamwork", "support"],
    "features": ["burden_sharer", "team_builder"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Trade if needed for preferences",
    ...
    "contraindications": [],
    "mechanisms": ["visual_distribution", "fair_allocation", "flexibility"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["weekly"],
    "where": ["home"],
    "involves": ["planning", "cards", "distribution"],
    "features": ["fairness_system", "visual_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Receive their thanks too",
    ...
    "contraindications": [],
    "mechanisms": ["daily_appreciation", "recognition", "positive_reinforcement"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["evening"],
    ...
    "features": ["appreciation_ritual", "daily_practice"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Finish together",
    ...
    "contraindications": [],
    "mechanisms": ["parallel_work", "companionship", "shared_time"],
    "effort": "minimal",
    "time": "varies",
    "cost": "$",
    "when": ["chore_time"],
    "where": ["home"],
    "involves": ["parallel_tasks", "companionship"],
    "features": ["efficiency_tool", "connection_maintainer"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Appreciate the results",
    ...
    "contraindications": [],
    "mechanisms": ["strength_utilization", "trust", "autonomy"],
    "effort": "minimal",
    "time": "planning",
    "cost": "$",
    "when": ["ongoing"],
    "where": ["home"],
    "involves": ["delegation", "trust", "expertise"],
    "features": ["efficiency_maximizer", "trust_builder"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Celebrate whoever finishes first (or both!)",
    ...
    "contraindications": [],
    "mechanisms": ["gamification", "competition", "fun_injection"],
    "effort": "minimal",
    "time": "varies",
    "cost": "$",
    "when": ["chore_time"],
    "where": ["home"],
    "involves": ["racing", "games", "chores"],
    "features": ["game_element", "motivation_tool"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Enjoy the freed time together",
    ...
    "contraindications": [],
    "mechanisms": ["problem_elimination", "outsourcing", "peace_creation"],
    "effort": "moderate",
    "time": "research",
    "cost": "$$$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["outsourcing", "budgeting", "planning"],
    "features": ["problem_solver", "peace_creator"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "ongoing"
  },
...
• Appreciate flexibility",
    ...
    "contraindications": [],
    "mechanisms": ["regular_review", "flexibility", "adaptation"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["quarterly"],
    "where": ["home"],
    "involves": ["review", "negotiation", "planning"],
    "features": ["flexibility_tool", "fairness_maintainer"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "quarterly"
  }
