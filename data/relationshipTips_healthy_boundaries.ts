...
export const HEALTHY_BOUNDARIES_TIPS: SimplifiedTip[] = [
  {
...
• Take the time guilt-free",
    ...
    "contraindications": [],
    "mechanisms": ["boundary_setting", "guilt_reduction", "autonomy_practice"],
    "effort": "minimal",
    "time": "varies",
    "cost": "$",
    "when": ["any"],
    "where": ["home"],
    "involves": ["boundary_setting", "alone_time"],
    "features": ["self_care", "boundary_practice"],
    "difficulty": 2,
...
• Allow them to have their feelings",
    ...
    "contraindications": [],
    "mechanisms": ["boundary_practice", "assertiveness", "limit_setting"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["saying_no", "boundaries"],
    "features": ["boundary_skill", "assertiveness_practice"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Respect their individual activities too",
    ...
    "contraindications": [],
    "mechanisms": ["identity_preservation", "individual_growth", "autonomy"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$$",
    "when": ["weekly"],
    "where": ["various"],
    "involves": ["hobbies", "individual_time"],
    "features": ["identity_preserver", "autonomy_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Share highlights after if desired",
    ...
    "contraindications": [],
    "mechanisms": ["social_independence", "friendship_maintenance", "individual_identity"],
    "effort": "low",
    "time": "3-4hrs",
    "cost": "$$",
    "when": ["monthly"],
    ...
    "features": ["social_boundary", "friendship_protector"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Move on without resentment",
    ...
    "contraindications": [],
    "mechanisms": ["boundary_respect", "acceptance", "safety_building"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["respect", "acceptance"],
    "features": ["respect_practice", "boundary_honoring"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Keep some things private",
    ...
    "contraindications": [],
    "mechanisms": ["privacy_preservation", "boundary_maintenance", "mystery"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["daily"],
    "where": ["bathroom"],
    "involves": ["privacy", "boundaries"],
    "features": ["privacy_tool", "simple_boundary"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Better sleep for both",
    ...
    "contraindications": [],
    "mechanisms": ["individual_comfort", "practical_solution", "conflict_prevention"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$$",
    "when": ["bedtime"],
    "where": ["bedroom"],
    "involves": ["sleep", "comfort", "practical"],
    "features": ["practical_boundary", "sleep_improver"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Notice it's okay to have inner world",
    ...
    "contraindications": [],
    "mechanisms": ["internal_boundary", "privacy_practice", "individuality"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["privacy", "internal_boundary"],
    "features": ["internal_boundary", "identity_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Try new boundary for two weeks",
    ...
    "contraindications": [],
    "mechanisms": ["negotiation", "flexibility", "compromise"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["planned"],
    "where": ["home"],
    "involves": ["discussion", "negotiation"],
    "features": ["boundary_flexibility", "negotiation_tool"],
    "difficulty": 3,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Ask questions later if needed",
    ...
    "contraindications": [],
    "mechanisms": ["unconditional_support", "respect", "trust_building"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["as_needed"],
    "where": ["any"],
    "involves": ["support", "respect"],
    "features": ["respect_tool", "support_practice"],
    "difficulty": 3,
    "source": "coach_curated",
