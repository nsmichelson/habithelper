...
export const MORE_PLAYFUL_TIPS: SimplifiedTip[] = [
  {
...
• Let it evolve into play or just lighten the mood`,
    ...
    "contraindications": [],
    "mechanisms": ["play_initiation", "pattern_interrupt", "physical_play"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any", "when_tense"],
    "where": ["home"],
    "involves": ["physical_play", "spontaneity"],
    "features": ["spontaneous", "tension_breaker"],
    "difficulty": 2,
...
• Let them evolve or change as desired`,
    ...
    "contraindications": [],
    "mechanisms": ["humor_creation", "inside_joke", "playful_language"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["humor", "creativity", "language"],
    "features": ["creative", "ongoing_fun"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Sing along if you want`,
    ...
    "contraindications": [],
    "mechanisms": ["music_joy", "movement", "task_transformation"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["dinner_prep", "evening"],
    "where": ["kitchen"],
    "involves": ["dancing", "music", "cooking"],
    "features": ["multitasking", "energy_booster"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Keep it light and fun`,
    ...
    "contraindications": [],
    "mechanisms": ["imagination_play", "question_game", "morning_lightness"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["morning", "coffee_time"],
    "where": ["home", "cafe"],
    "involves": ["game", "conversation", "coffee"],
    "features": ["morning_ritual", "simple_game"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Enjoy imagining their discovery`,
    ...
    "contraindications": [],
    "mechanisms": ["surprise", "humor", "creative_expression"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["any"],
    "where": ["home"],
    "involves": ["drawing", "hiding", "surprise"],
    "features": ["creative", "surprise_element"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Be dramatic about winning or losing`,
    ...
    "contraindications": [],
    "mechanisms": ["physical_play", "competition_play", "touch"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["game", "touch", "competition"],
    "features": ["instant_play", "no_prep"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Laugh when you inevitably do`,
    ...
    "contraindications": [],
    "mechanisms": ["role_play", "public_play", "shared_adventure"],
    "effort": "minimal",
    "time": "30-60min",
    "cost": "$",
    "when": ["errands", "shopping"],
    "where": ["public", "stores"],
    "involves": ["role_play", "accents", "public"],
    "features": ["public_play", "adventure"],
    "difficulty": 3,
    "source": "coach_curated",
...
• No phones allowed in the fort`,
    ...
    "contraindications": [],
    "mechanisms": ["environment_creation", "novelty", "childlike_state"],
    "effort": "low",
    "time": "30-60min",
    "cost": "$",
    "when": ["evening", "weekend"],
    "where": ["home"],
    "involves": ["fort_building", "dinner", "creativity"],
    "features": ["creative_project", "novel_experience"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• See who sends the funniest ones`,
    ...
    "contraindications": [],
    "mechanisms": ["creative_constraint", "humor", "play_communication"],
    "effort": "minimal",
    "time": "0-60min",
    "cost": "$",
    "when": ["any"],
    "where": ["remote"],
    "involves": ["texting", "GIFs", "creativity"],
    "features": ["remote_play", "creative_constraint"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Celebrate whoever breaks first`,
    ...
    "contraindications": [],
    "mechanisms": ["laughter_generation", "playful_competition", "joy_focus"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any", "when_stressed"],
    "where": ["any"],
    "involves": ["humor", "competition", "laughter"],
    "features": ["quick_game", "mood_lifter"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  }
