...
export const STRONGER_CONNECTIONS_TIPS: SimplifiedTip[] = [
  {
...
• Thank them for listening without fixing",
    ...
    "contraindications": [],
    "mechanisms": ["vulnerability_practice", "emotional_sharing", "intimacy_building"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["any", "evening"],
    ...
    "features": ["intimacy_builder", "trust_exercise"],
    "difficulty": 3,
...
• Share your own childhood dream in return",
    ...
    "contraindications": [],
    "mechanisms": ["identity_exploration", "storytelling", "mutual_sharing"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["dinner", "evening"],
    "where": ["home", "restaurant"],
    "involves": ["conversation", "memories", "dining"],
    "features": ["mealtime_activity", "memory_sharing"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Make eye contact while sharing",
    ...
    "contraindications": [],
    "mechanisms": ["positive_reinforcement", "ritual_building", "gratitude"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    ...
    "features": ["bedtime_ritual", "daily_practice"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Focus on discovery over perfection",
    ...
    "contraindications": [],
    "mechanisms": ["novelty_seeking", "shared_planning", "anticipation"],
    "effort": "low",
    "time": "2-3hrs",
    "cost": "$$",
    "when": ["weekend"],
    "where": ["various", "outdoors"],
    "involves": ["adventure", "planning", "exploration"],
    "features": ["weekend_activity", "novelty"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Review together weekly",
    ...
    "contraindications": [],
    "mechanisms": ["visual_connection", "daily_ritual", "memory_creation"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    ...
    "features": ["digital_tool", "daily_practice"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Discuss one way to show love in their language this week",
    ...
    "contraindications": [],
    "mechanisms": ["assessment", "understanding_differences", "targeted_care"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["quiz", "discussion", "learning"],
    "features": ["educational", "assessment_tool"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Watch for their reaction and enjoy the surprise",
    ...
    "contraindications": [],
    "mechanisms": ["surprise", "written_affirmation", "thoughtful_gesture"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["any"],
    ...
    "features": ["surprise_element", "tangible_reminder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Together plan: What's our next shared adventure?",
    ...
    "contraindications": [],
    "mechanisms": ["regular_review", "proactive_communication", "shared_planning"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["monthly"],
    "where": ["home"],
    "involves": ["check_in", "planning", "review"],
    "features": ["monthly_ritual", "relationship_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  },
...
• Listen without immediately offering solutions",
    ...
    "contraindications": [],
    "mechanisms": ["support_seeking", "explicit_needs", "team_building"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening", "weekend"],
    "where": ["home"],
    "involves": ["conversation", "support", "listening"],
    "features": ["support_tool", "stress_management"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Share what you remember feeling that day",
    ...
    "contraindications": [],
    "mechanisms": ["nostalgia", "memory_activation", "romance_renewal"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$$",
    "when": ["evening", "weekend"],
    "where": ["various"],
    "involves": ["date", "recreation", "memories"],
    "features": ["romantic", "memory_based"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "monthly"
  }
