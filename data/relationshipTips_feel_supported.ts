...
export const FEEL_SUPPORTED_TIPS: SimplifiedTip[] = [
  {
...
• Thank them specifically afterward",
    ...
    "contraindications": [],
    "mechanisms": ["help_requesting", "vulnerability", "interdependence_building"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["any"],
    "where": ["home"],
    "involves": ["asking", "receiving_help"],
    "features": ["vulnerability_practice", "simple_start"],
    "difficulty": 2,
...
• Ask about their preferences too",
    ...
    "contraindications": [],
    "mechanisms": ["preference_sharing", "support_optimization", "clarity"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["calm_moment"],
    "where": ["home"],
    "involves": ["conversation", "preference_sharing"],
    "features": ["support_optimization", "stress_tool"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Receive the comfort fully",
    ...
    "contraindications": [],
    "mechanisms": ["comfort_acceptance", "emotional_holding", "support_receiving"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["when_upset"],
    "where": ["home", "private"],
    "involves": ["comfort", "vulnerability"],
    "features": ["emotional_support", "receiving_practice"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Respond immediately when hearing it",
    ...
    "contraindications": [],
    "mechanisms": ["simplified_communication", "quick_access", "pre_planning"],
    "effort": "minimal",
    "time": "5-15min",
    "cost": "$",
    "when": ["once"],
    "where": ["home"],
    "involves": ["planning", "agreement"],
    "features": ["communication_tool", "accessibility"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Learn theirs in return",
    ...
    "contraindications": [],
    "mechanisms": ["preference_identification", "support_matching", "effectiveness"],
    "effort": "minimal",
    "time": "15-30min",
    "cost": "$",
    "when": ["evening"],
    "where": ["home"],
    "involves": ["self_reflection", "sharing"],
    "features": ["self_discovery", "optimization_tool"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Enjoy the shared joy",
    ...
    "contraindications": [],
    "mechanisms": ["joy_amplification", "celebration_request", "positive_sharing"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["celebration", "sharing_joy"],
    "features": ["joy_amplifier", "positive_focus"],
    "difficulty": 1,
    "source": "coach_curated",
...
• Offer reciprocal support",
    ...
    "contraindications": [],
    "mechanisms": ["accountability_partnership", "team_building", "mutual_support"],
    "effort": "low",
    "time": "15-30min",
    "cost": "$",
    "when": ["planned"],
    "where": ["home"],
    "involves": ["goal_sharing", "accountability"],
    "features": ["growth_tool", "partnership"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Post somewhere visible",
    ...
    "contraindications": [],
    "mechanisms": ["advance_planning", "strategy_creation", "clarity"],
    "effort": "low",
    "time": "30-45min",
    "cost": "$",
    "when": ["weekend"],
    "where": ["home"],
    "involves": ["planning", "strategy"],
    "features": ["proactive_tool", "stress_management"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "once"
  },
...
• Express gratitude for their ongoing support",
    ...
    "contraindications": [],
    "mechanisms": ["gratitude_expression", "positive_reinforcement", "memory_sharing"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["gratitude", "reflection"],
    "features": ["appreciation_tool", "reinforcement"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Let yourself feel supported",
    ...
    "contraindications": [],
    "mechanisms": ["reception_practice", "worthiness_building", "grace_development"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["any"],
    "involves": ["receiving", "gratitude"],
    "features": ["worthiness_practice", "simple_shift"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "daily"
  }
