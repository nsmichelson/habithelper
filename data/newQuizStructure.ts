...
export const NEW_QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  // ========== NEW STEP 5: EATING DRIVER IDENTIFICATION ==========
  {
    ...
    options: [
      ...
      { value: 'tiredness_exhaustion', label: '😴 I\'m exhausted and reaching for energy/comfort' },
      ...
      { value: 'night_waking', label: '🌙 I wake up at night and end up eating' },
      { value: 'procrastination', label: '📝 I\'m avoiding something I should be doing' },
...
const DRIVER_MAPPINGS: Record<string, string> = {
  ...
  'tiredness_exhaustion': 'driver:energy_seeking',
  'ritual_habit': 'driver:situational_habit',
  'autopilot': 'driver:autopilot',
  'night_waking': 'driver:sleep_disruption',
  'procrastination': 'driver:avoidance',
