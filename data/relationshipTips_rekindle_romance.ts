...
export const REKINDLE_ROMANCE_TIPS: SimplifiedTip[] = [
  {
...
• Notice the different energy it creates",
    ...
    "contraindications": [],
    "mechanisms": ["extended_touch", "hormone_release", "intentional_intimacy"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["departures", "morning"],
    "where": ["home"],
    "involves": ["kissing", "physical_intimacy"],
    "features": ["daily_romance", "simple_shift"],
    "difficulty": 1,
...
• Keep it light and fun",
    ...
    "contraindications": [],
    "mechanisms": ["anticipation_building", "flirtation", "romantic_reminder"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["workday", "afternoon"],
    "where": ["work"],
    "involves": ["texting", "flirting"],
    "features": ["workday_romance", "anticipation_builder"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "daily"
  },
...
• Treat it like a date",
    ...
    "contraindications": [],
    "mechanisms": ["effort_demonstration", "novelty", "attraction_renewal"],
    "effort": "low",
    "time": "30-60min",
    "cost": "$",
    "when": ["dinner", "evening"],
    "where": ["home"],
    "involves": ["dressing_up", "dinner", "effort"],
    "features": ["home_date", "effort_display"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Kiss like it's the first time again",
    ...
    "contraindications": [],
    "mechanisms": ["memory_reactivation", "nostalgia", "romantic_pilgrimage"],
    "effort": "low",
    "time": "1-2hrs",
    "cost": "$",
    "when": ["weekend"],
    "where": ["special_location"],
    "involves": ["outing", "kissing", "memories"],
    "features": ["memory_based", "romantic_gesture"],
    "difficulty": 2,
    "source": "coach_curated",
...
• Let them discover it naturally",
    ...
    "contraindications": [],
    "mechanisms": ["surprise", "romantic_gesture", "unexpected_love"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["bathroom"],
    "involves": ["writing", "surprise", "romance"],
...
• No talking, just presence",
    ...
    "contraindications": [],
    "mechanisms": ["physical_closeness", "music_romance", "intimate_movement"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["after_dinner", "evening"],
    "where": ["home"],
    "involves": ["dancing", "music", "touch"],
    "features": ["romantic_ritual", "physical_connection"],
    "difficulty": 1,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Make them feel wanted",
    ...
    "contraindications": [],
    "mechanisms": ["desire_expression", "physical_validation", "attraction_verbalization"],
    "effort": "minimal",
    "time": "0-5min",
    "cost": "$",
    "when": ["any"],
    "where": ["private"],
    "involves": ["compliments", "attraction", "verbalization"],
    "features": ["desire_expression", "validation"],
    "difficulty": 2,
    "source": "coach_curated",
    "sustainability": "weekly"
  },
...
• Present as surprise gift",
    ...
    "contraindications": [],
    "mechanisms": ["surprise_planning", "thoughtful_effort", "attention_to_interests"],
    "effort": "moderate",
    "time": "2-4hrs",
    "cost": "$$",
    "when": ["weekend"],
    "where": ["various"],
    "involves": ["planning", "surprise", "date"],
    "features": ["surprise_date", "thoughtful_planning"],
    "difficulty": 3,
    "source": "coach_curated",
...
• Receive their response openly",
    ...
    "contraindications": [],
    "mechanisms": ["vulnerable_sharing", "desire_expression", "intimacy_expansion"],
    "effort": "moderate",
    "time": "15-30min",
    "cost": "$",
    "when": ["private_moment"],
    "where": ["bedroom", "private"],
    "involves": ["sharing", "vulnerability", "fantasy"],
    "features": ["intimate_sharing", "expansion_tool"],
    "difficulty": 4,
    "source": "coach_curated",
...
• Focus entirely on romance and connection",
    ...
    "contraindications": [],
    "mechanisms": ["environment_change", "novelty", "dedicated_time"],
    "effort": "moderate",
    "time": "overnight",
    "cost": "$$$",
    "when": ["weekend"],
    "where": ["hotel"],
    "involves": ["getaway", "romance", "novelty"],
    "features": ["romance_escape", "novelty_creator"],
    "difficulty": 3,
    "source": "coach_curated",
