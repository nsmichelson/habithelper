...
export const GOAL_MAPPINGS: Record<string, string[]> = {
  ...
  'increase_protein': ['increase_protein', 'protein_intake'],
  ...
  'go_plant_based': ['plant_based', 'increase_veggies', 'increase_vegetables'],
  ...
  'gain_muscle_eating': ['muscle_gain', 'protein_intake', 'increase_protein'],
  ...
  'lower_carbs': ['reduce_carbs', 'stable_blood_sugar'],
  'reduce_fat': ['reduce_fat', 'better_lipids'],
  'lower_sodium': ['reduce_sodium', 'heart_health'],
  ...
  'dating_confidence': ['dating_confidence', 'build_confidence', 'self_awareness'],
...
export const NEW_EATING_GOALS_TO_ADD = [
  ...
  { value: 'go_plant_based', label: 'Switch to plant-based' },
  ...
  { value: 'gain_muscle_eating', label: 'Build muscle' },
  ...
  { value: 'lower_carbs', label: 'Lower carb intake' },
