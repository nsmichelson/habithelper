...
export default function DailyTipCard({ tip, onResponse, reasons = [] }: Props) {
  ...
  const toggleExpanded = () => {
    ...
    detailsHeight.value = withSpring(expanded ? 0 : 1);
    flipRotation.value = withSpring(expanded ? 0 : 180);
  };
  ...
  const getTimeLabel = (time: string) => {
    ...
    return labels[time as keyof typeof labels];
  };
      ...
      >
        ...
        <TouchableOpacity style={styles.expandButton} onPress={toggleExpanded}>
          <Text style={styles.expandButtonText}>
            {expanded ? 'Hide Details' : 'See How To Do It'}
          </Text>
